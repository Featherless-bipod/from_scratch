...
class EvaluationCallback(pl.Callback):
    ...
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        if heldout.shape[-1] > 0:
            # We actually have ground truth neurons to grade against
            ...
            # This is a blind test. We can't calculate BPS. Just log zeros or skip.
            pl_module.log("nlb/co_bps", 0.0)
            pl_module.log("nlb/fp_bps", 0.0)
